...
let userID = 'f1b85bf0-2c88-40d7-8e92-2da147af372d';

// https://www.nslookup.io/domains/cdn.xn--b6gac.eu.org/dns-records/
// https://www.nslookup.io/domains/cdn-all.xn--b6gac.eu.org/dns-records/
const proxyIPs= ['cdn.xn--b6gac.eu.org', 'www.visa.cn.cdn.cloudflare.net', 'cdn.anycast.eu.org'];
            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    default:
                        ...
                        url.hostname = 'blog.sunxizhen.xyz';
                        url.protocol = 'https:';
...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `XZ- Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `XZ - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `XZ - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `XZ - Clean IP_${index - 5} : ${port}`;
            break;
    }
